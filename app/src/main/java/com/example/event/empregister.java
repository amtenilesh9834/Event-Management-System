...
public class empregister extends AppCompatActivity  {
    ...
    Button empbuttonSignup;
    TextView emplogintext;
    ...
    {
        super.onBackPressed();
        startActivity(new Intent(empregister.this, emplogin.class));
        finish();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_empregister);
        ...
        emplogintext = findViewById(R.id.emploginText);
        empbuttonSignup = findViewById(R.id.empbuttonSignUp);
...
//        });
        ...
        emplogintext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(empregister.this, emplogin.class);
        ...
        empbuttonSignup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                RequestQueue queue = Volley.newRequestQueue(empregister.this);
                ...
                if (!fullname.isEmpty() && !username.isEmpty() && !email.isEmpty() && !password.isEmpty()) {
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://192.168.0.101/EventManagement/empsignup.php", new Response.Listener<String>() {
                        @Override
                    ...
                    }, new Response.ErrorListener()
                    {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            Toast.makeText(empregister.this, error.getMessage(), Toast.LENGTH_LONG).show();
                        }
                    }) {
                        @Override
