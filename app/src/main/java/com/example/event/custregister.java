...
public class custregister extends AppCompatActivity  {
    ...
    Button custbuttonSignup;
    TextView custlogintext;
    ...
    {
        super.onBackPressed();
        startActivity(new Intent(custregister.this, custlogin.class));
        finish();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        custlogintext = findViewById(R.id.custloginText);
        custbuttonSignup = findViewById(R.id.custbuttonSignUp);
...
//        });
        ...
        custlogintext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(custregister.this, custlogin.class);
        ...
        custbuttonSignup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                RequestQueue queue = Volley.newRequestQueue(custregister.this);
                ...
                if (!fullname.isEmpty() && !username.isEmpty() && !email.isEmpty() && !password.isEmpty()) {
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://192.168.0.101/EventManagement/custsignup.php", new Response.Listener<String>() {
                        @Override
                    ...
                    }, new Response.ErrorListener()
                    {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            Toast.makeText(custregister.this, error.getMessage(), Toast.LENGTH_LONG).show();
                        }
                    }) {
                        @Override
